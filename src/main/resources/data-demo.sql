...
INSERT INTO eventos (id, nombre, descripcion, fecha, hora, ubicacion, aforo_maximo, entradas_vendidas, precio_base, estado, organizador_id, version) VALUES
  (2001, 'Concierto Jazz Bilbao',  'EarlyBird 0% de ocupacion.',   DATEADD('MONTH', 2, CURRENT_DATE), '20:00:00', 'Bilbao',          100, 0,  50.00, 'PUBLICADO', 1001, 0),
  (2002, 'Festival Indie Donosti', 'Regular 60% de ocupacion.',    DATEADD('MONTH', 2, CURRENT_DATE), '21:00:00', 'San Sebastian',   100, 60, 80.00, 'PUBLICADO', 1001, 0),
  (2003, 'Show Stand-Up Vitoria',  'LastMinute 90% de ocupacion.', DATEADD('MONTH', 1, CURRENT_DATE), '22:00:00', 'Vitoria',         100, 90, 30.00, 'PUBLICADO', 1001, 0),
  (2004, 'Final Liga Esports',     'AGOTADO 100% de ocupacion.',   DATEADD('MONTH', 3, CURRENT_DATE), '19:00:00', 'Bilbao Arena',     50, 50, 25.00, 'AGOTADO',   1001, 0),
  (2005, 'Charla Tech (Borrador)', 'Aun sin publicar (BORRADOR).', DATEADD('MONTH', 6, CURRENT_DATE), '18:00:00', 'Bilbao',          200, 0,  0.00,  'BORRADOR',  1001, 0);
